...
theme.SearchResultsTemplate = (function() {
  ...
  function loadingState() {
    return [
      ...
      '<span class="icon-predictive-search-spinner"></span>',
      '</span>',
      '<span class="predictive-search-loading__title">' +
  ...
  function renderViewAll(searchQuery) {
    return [
      '<button type="submit" class="predictive-search-view-all" tabindex="-1">',
  ...
  function renderProducts(products, searchQuery) {
    ...
    return [
      ...
      products
        ...
        .join(''),
      '<li id="search-all" role="option" data-search-result>' +
  ...
  function renderProduct(product, index, resultsCount) {
    return [
      '<li id="search-result-' +
        ...
        (index + 1 === resultsCount ? 'predictive-search-item--last' : '') +
        '" role="option" data-search-result>',
...
// Enable Variant Select by Clicking Product Thumbnails
